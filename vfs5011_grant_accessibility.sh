...
# Deploy. That's why vfs5011_agent_install.sh now calls this script
...
# binary bytes.
#
# Usage: sudo ./vfs5011_grant_accessibility.sh [path-to-daemon-binary]
#        (defaults to the standard install path if omitted)
set -e

DAEMON_PATH="${1:-/Library/Application Support/VFSDaemon/vfs5011_daemon}"
